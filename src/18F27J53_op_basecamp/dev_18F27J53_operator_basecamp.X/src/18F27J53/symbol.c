...
{
    //T1CON = 0b00111000;         //NB: obviously, this is TMR1 that is used!
    T1CON = 0b00110000;         //NB: patch: disable T1CLK output!
    PIR1bits.TMR1IF = 0;
    PIE1bits.TMR1IE = 1;
    T1CONbits.TMR1ON = 1;

    // why in hell does that shit above stop timer4 interrupt ?
