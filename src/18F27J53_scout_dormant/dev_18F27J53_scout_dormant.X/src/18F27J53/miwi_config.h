...
/*********************************************************************/
#define MY_ADDRESS_LENGTH       4   // ALWAYS! if not, we have to modify
                                    // the way myLongAddress is defined
                                    // in miwi_mesh.c !
...
// This is the unique hardware address
// we don't use it anymore. Using myMODEL & myUID values instead.
...
/*********************************************************************/
#define CONNECTION_SIZE             10  // 10 even seems a bit overkill for a scout
