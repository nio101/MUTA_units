...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/dev_18F27J53_scout_dormant.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=src/18F27J53/console.c src/18F27J53/delay.c src/18F27J53/spi.c src/18F27J53/symbol.c src/18F27J53/system.c src/miwi/drv_mrf_miwi_89xa.c src/miwi/drv_mrf_miwi_crc.c src/miwi/drv_mrf_miwi_security.c src/miwi/miwi_mesh.c src/main.c ../../muta/muta_messages.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/18F27J53/console.p1 ${OBJECTDIR}/src/18F27J53/delay.p1 ${OBJECTDIR}/src/18F27J53/spi.p1 ${OBJECTDIR}/src/18F27J53/symbol.p1 ${OBJECTDIR}/src/18F27J53/system.p1 ${OBJECTDIR}/src/miwi/drv_mrf_miwi_89xa.p1 ${OBJECTDIR}/src/miwi/drv_mrf_miwi_crc.p1 ${OBJECTDIR}/src/miwi/drv_mrf_miwi_security.p1 ${OBJECTDIR}/src/miwi/miwi_mesh.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/_ext/1853667253/muta_messages.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/18F27J53/console.p1.d ${OBJECTDIR}/src/18F27J53/delay.p1.d ${OBJECTDIR}/src/18F27J53/spi.p1.d ${OBJECTDIR}/src/18F27J53/symbol.p1.d ${OBJECTDIR}/src/18F27J53/system.p1.d ${OBJECTDIR}/src/miwi/drv_mrf_miwi_89xa.p1.d ${OBJECTDIR}/src/miwi/drv_mrf_miwi_crc.p1.d ${OBJECTDIR}/src/miwi/drv_mrf_miwi_security.p1.d ${OBJECTDIR}/src/miwi/miwi_mesh.p1.d ${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/_ext/1853667253/muta_messages.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/18F27J53/console.p1 ${OBJECTDIR}/src/18F27J53/delay.p1 ${OBJECTDIR}/src/18F27J53/spi.p1 ${OBJECTDIR}/src/18F27J53/symbol.p1 ${OBJECTDIR}/src/18F27J53/system.p1 ${OBJECTDIR}/src/miwi/drv_mrf_miwi_89xa.p1 ${OBJECTDIR}/src/miwi/drv_mrf_miwi_crc.p1 ${OBJECTDIR}/src/miwi/drv_mrf_miwi_security.p1 ${OBJECTDIR}/src/miwi/miwi_mesh.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/_ext/1853667253/muta_messages.p1

# Source Files
SOURCEFILES=src/18F27J53/console.c src/18F27J53/delay.c src/18F27J53/spi.c src/18F27J53/symbol.c src/18F27J53/system.c src/miwi/drv_mrf_miwi_89xa.c src/miwi/drv_mrf_miwi_crc.c src/miwi/drv_mrf_miwi_security.c src/miwi/miwi_mesh.c src/main.c ../../muta/muta_messages.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-18F27J53.mk dist/${CND_CONF}/${IMAGE_TYPE}/dev_18F27J53_scout_dormant.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/src/18F27J53/console.p1: src/18F27J53/console.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"src" -I"src/18F27J53" -I"src/miwi" -I"../../../xc8/v1.35/include" --warn=0 --asmlist -DXPRJ_18F27J53=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/src/18F27J53/console.p1  src/18F27J53/console.c 
...
${OBJECTDIR}/src/18F27J53/console.p1: src/18F27J53/console.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/18F27J53/console.p1.d 
	@${RM} ${OBJECTDIR}/src/18F27J53/console.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"src" -I"src/18F27J53" -I"src/miwi" -I"../../../xc8/v1.35/include" --warn=0 --asmlist -DXPRJ_18F27J53=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/src/18F27J53/console.p1  src/18F27J53/console.c 
	@-${MV} ${OBJECTDIR}/src/18F27J53/console.d ${OBJECTDIR}/src/18F27J53/console.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/src/18F27J53/console.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/dev_18F27J53_scout_dormant.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/dev_18F27J53_scout_dormant.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"src" -I"src/18F27J53" -I"src/miwi" -I"../../../xc8/v1.35/include" --warn=0 --asmlist -DXPRJ_18F27J53=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/dev_18F27J53_scout_dormant.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/dev_18F27J53_scout_dormant.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/dev_18F27J53_scout_dormant.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/dev_18F27J53_scout_dormant.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 -I"src" -I"src/18F27J53" -I"src/miwi" -I"../../../xc8/v1.35/include" --warn=0 --asmlist -DXPRJ_18F27J53=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/dev_18F27J53_scout_dormant.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
